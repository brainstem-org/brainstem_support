...
- **Organize experiments**: Create structured [Behavioral Assays]({{site.baseurl}}/tutorials/behavioral-assays) that integrate with your data storage system for organized behavioral data
