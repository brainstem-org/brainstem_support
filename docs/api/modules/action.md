...
A detailed list of the accepted schemas for the `type_json` field, related to each `type`, can be found in the [action schemas page]({{"../schemas/actions/"|absolute_url}}).
