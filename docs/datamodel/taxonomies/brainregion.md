...
| ``Description`` | A general description of the brain region (maximum length: 2000 characters) |
...
| ``Parent acronym`` | The acronym of the parent region in the hierarchical structure of the brain atlas (maximum length: 15 characters) |
