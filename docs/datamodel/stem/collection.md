...
| Field | Description |
|:------|:------------|
| `Collection name` | Name of the collection (**required**; string; maximum length: 100 characters; must be unique within the project). Example: "Place Cell Analysis", "Learning Sessions Day 1-5" |
