...
1. [__Behaviors__]({{"datamodel/modules/behavior"|absolute_url}}): Description of the animal subject(s) behavior during the session collection. A behavior is described by two personal attributes: the setup and the behavioral assay.
